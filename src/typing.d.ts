// Definitions by: Arthur A. Bergamaschi <https://github.com/arthurbergmz/webpack-pwa-manifest>

declare class workboxWebpackPlugin {}

declare class PwaManifest {
  constructor(options: PwaManifest.ManifestOptions);
}

declare namespace PwaManifest {
...
export { PwaManifest, workboxWebpackPlugin };
